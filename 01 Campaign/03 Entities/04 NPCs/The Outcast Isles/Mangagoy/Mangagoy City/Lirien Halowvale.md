...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/LirienHalowvaleSmall.webp
language:
  - Common, Elven
location:
  - "[[Whisperwind Suites]]"
...
## Overview
Slender and ghostlike, Lirien Halowvale floats through Whisperwind Suites like mist. Their robes shimmer with moonlight, and they speak only in whispers. A ward against scrying guards the VIP rooms, but Room 7—long sealed and haunted by phantom bookings—remains their greatest concern. Lirien’s mission is to keep that door closed and its secrets buried.
