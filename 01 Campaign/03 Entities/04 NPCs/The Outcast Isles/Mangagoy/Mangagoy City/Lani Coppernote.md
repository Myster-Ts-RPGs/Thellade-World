...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/LaniCoppernoteSmall.webp
language:
  - Common
location:
  - "[[Whisperwind Suites]]"
...
## Overview
Lani Coppernote is one of the 44 stewards of [[Whisperwind Suites]], a halfling boy with bright eyes and an ever-serene expression. His uniform is always perfectly aligned, and he moves with silent, rhythmic precision, his presence barely acknowledged until needed. In the atrium each evening, he plays a delicate harp melody — notes flawless, gaze unblinking.

Though enchanted to serve without question, Lani is one of two sentient stewards. His music hides messages meant for no one and everyone. He has never spoken out of turn — but he has remembered every name and every room that ever vanished behind a sealed door.
