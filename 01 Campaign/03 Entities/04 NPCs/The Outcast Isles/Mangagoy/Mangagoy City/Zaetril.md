...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/ZaetrilSmall.webp
language:
  - Common
  - Draconic
location:
...
> SORT file.name ASC
## Overview
A thin, gold-scaled kobold with a lens embedded in his left eye, Zaetril runs the Glowglass Arcanum. Brilliant yet obsessive, he collects broken magical items in pursuit of rebuilding the Lens of Reverberation—a Pre-Rising artifact said to amplify planar echoes. He mistrusts divine casters and whispers to his spells as if coaxing them to life. His lab is filled with unstable crystals and magical glasswork.
