...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/DrenmarValeSmall.webp
language:
  - Common
location:
  - "[[Whisperwind Suites]]"
...
## Overview
Drenmar Vale is one of the 44 magically conditioned stewards of [[Whisperwind Suites]], a young halfling woman dressed in immaculate uniform. She speaks only when addressed twice in succession and moves in flawless coordination with the other staff. Her expression is serene, her footsteps nearly silent, and the lanterns she carries never flicker.

Though outwardly obedient, Drenmar is one of two stewards who have become self-aware. She hides her sentience beneath layers of rote performance, quietly memorizing guest patterns and waiting for the moment when knowing more becomes a liability.
