...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/JorekSmall.webp
language:
  - Common
location:
  - "[[Scroll & Sand]]"
...
## Overview
Jorek is Elinya Sash’s half-elf apprentice at [[Scroll & Sand]]. He manages the front desk with quiet diligence, often found ink-smudged and muttering over ancient maps or piecing together shattered scrolls. Though soft-spoken, he’s fiercely protective of the shop and refers to the books by name. Elinya claims he once dove into storm-tossed waters to save a crate of ledgers—and that it wasn’t the first time.
