...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/WardenDraven.png
language:
  - Common
location:
  - "[[Mangagoy]]"
...
## Overview
Garron Draven is the current Warden of Mangagoy, overseeing both civic logistics and military preparedness. A veteran with a rigid sense of duty, Draven is often seen as unyielding but fair. His relationships with the Ashen Vanguard and the Concord Library leadership are professional, though he resents both groups' tendency to meddle in city policy. His main concern is maintaining order as magical instability increases throughout the region.
