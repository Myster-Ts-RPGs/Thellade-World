...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/MerraTidewellSmall.webp
language:
  - Common
location:
  - "[[Whisperwind Suites]]"
...
## Overview
Merra Tidewell is a gnome steward assigned to dietary coordination at [[Whisperwind Suites]]. His sharp memory allows him to recall every guest's allergies, preferences, and rituals—down to the hour and the garnish. He glides through the service halls with a quiet grace, silver trays never clattering, meals always precisely timed.

Though enchanted like the rest of the 44, Merra is unusually aware. He records more than just menus—marking the cadence of magical anomalies and unaccounted guests in a secret copper ledger hidden beneath the pantry floor. His smile is professional; his silence, absolute.
