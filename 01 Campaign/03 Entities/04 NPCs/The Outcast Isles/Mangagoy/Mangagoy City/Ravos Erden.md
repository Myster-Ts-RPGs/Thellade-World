...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/RavosErdenSmall.webp
language:
  - Common
location:
  - "[[Whisperwind Suites]]"
...
## Overview
Ravos Erden is a female half-elf, half-gnome steward stationed at [[Whisperwind Suites]], known for her poised silence and unshakable routine. She navigates the upper balconies and noble guest wings with quiet precision, always carrying exactly what was requested—no more, no less. Her braid is flawless, her armor polished, her footsteps inaudible.

Though enchanted to obey, Ravos is one of the few stewards with sentient awareness. She spends her off-hours watching the clouds above the courtyard, as if weighing secrets too heavy for enchanted lips. The key to Room 7 once hung from her belt. It no longer does.
