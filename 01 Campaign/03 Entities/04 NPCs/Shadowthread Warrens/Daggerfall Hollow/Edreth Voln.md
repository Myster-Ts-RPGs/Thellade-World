...
tags:
  ...
  - "#NPC"
  - "#TODO"
art: 90 Assets/Images/NPCs/EdrethVolnSmall.webp
language:
  - Common
party1relation:
  - Unmet
...
An aging half-elf with an iron-gray ponytail, ink-stained fingertips, and a permanent squint from decades of candlelit ledger work. Edreth speaks with clipped precision and has little tolerance for inefficiency, but his memory for routing codes and courier sigils is unmatched in the Crossing. He oversees daily operations at the [[Courier Registry]] and is known for his uncanny ability to detect forged manifests just by weight and smell.
