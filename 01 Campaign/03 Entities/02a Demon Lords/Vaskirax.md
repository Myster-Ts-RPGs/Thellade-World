...
enemies: []
aliases:
  - The Scaled Lord of Tyranny
  - The Fang-Crowned Tyrant
---
...
### **📜 Vaskirax, the Scaled Lord of Tyranny** _(Proposed)_

- **Title**: _The Fang-Crowned Tyrant_
    
- **Domains**: Tyranny, Domination, Monstrosity, Pride
    
- **Sacred Animal**: Monitor lizard, giant crocodile
    
- **Symbol**: A jagged crown impaled through a coiled serpent
    
- **Cult Focus**: Worshipped by broken Iruxi dynasties and warped swamp tribes
    
- **Ritual Themes**: Blood sacrifice, bone armor, enforced obedience
    
- **PF2e Parallel**: Sess’innek
    
- **5e Parallel**: Sess’innek / Zehir fusion
    
- **Thellade Placement**: Active in Deep Dark ruins, mangrove-dead zones of Mangagoy, and the Saltmarsh Blight where scaled cults attempt resurrection of ancient lizard empires