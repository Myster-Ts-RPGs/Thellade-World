...
> ```dataview
> TABLE without id file.link AS "Name", join(aliases, ", ") AS Aliases, parentgalaxy AS Galaxy
> FROM "01 Campaign"
...
> ```dataview
> TABLE without id file.link AS "Name", join(aliases, ", ") AS Aliases, parentstarsystem AS "Star System", parentgalaxy AS Galaxy
> FROM "01 Campaign"
