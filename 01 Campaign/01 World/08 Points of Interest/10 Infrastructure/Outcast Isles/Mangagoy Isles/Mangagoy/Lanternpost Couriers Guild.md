...
This regional headquarters for the Lanternpost Couriers manages high-value message and parcel transfers. Guild-trained couriers rest here between runs, and teleportation circles are housed in the sublevel for secure dispatches.
