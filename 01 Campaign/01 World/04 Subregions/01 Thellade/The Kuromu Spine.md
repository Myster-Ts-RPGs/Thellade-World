...
## Overview 
> [!quote]
> *“Stone-born jungles where the sky grows teeth.”*
...
### 🔍 **Notable Features**:
- **The Verdant Rift**—a 500-meter bioluminescent sinkhole hidden by canopy fog.
- **Wyrmglass Cliffs**—obsidian cliffs that shed cursed shards after thunderstorms.
- **Breathing Stones**—hot springs that pulse with air from deep geologic vents.
