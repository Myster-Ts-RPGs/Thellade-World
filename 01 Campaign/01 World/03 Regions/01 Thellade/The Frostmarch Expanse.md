...
views:
  - type: table
    ...
    filters:
      and:
        - contains(property.location, "[[The Frostmarch Expanse]]")
        - contains(property.tags, "Location/Settlement")
    order:
      - file.name
      - tags
      - location
...
> *“The wind knows no law here—only memory, ice, and the will to endure.”*
