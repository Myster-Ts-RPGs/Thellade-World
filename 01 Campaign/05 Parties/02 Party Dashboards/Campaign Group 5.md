...
>> ```dataview
>> TABLE without id file.link AS "Name", party5tie AS "Party Link"
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Family")
>> SORT file.name ASC
> 
...
>> TABLE without id file.link AS "Name", party5tie AS "Party Link"
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Mentor")
>> SORT file.name ASC
>
>> [!metadata|ally] Ally
>> ```dataview
...
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Ally")
>> SORT file.name ASC
> 
...
>> TABLE without id file.link AS "Name", join(aliases, ", ") AS Aliases
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Friend")
>> SORT file.name ASC
>
>> [!metadata|like] Like
>> ```dataview
>> TABLE without id file.link AS "Name", join(aliases, ", ") AS Aliases
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Like")
>> SORT file.name ASC
> 
...
>> TABLE without id file.link AS "Name", join(aliases, ", ") AS Aliases
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Dislike")
>> SORT file.name ASC
> 
...
>> TABLE without id file.link AS "Name", join(aliases, ", ") AS Aliases
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Enemy")
>> SORT file.name ASC
> 
...
>> TABLE without id file.link AS "Name", join(aliases, ", ") AS Aliases
>> FROM "01 Campaign"
>> WHERE contains(tags, "#NPC") AND contains(party5relation, "Nemesis")
>> SORT file.name ASC
...
>> ```dataview
>> TABLE without id file.link AS "Location", party5reputation AS "Reputation"
>> FROM "01 Campaign"
>> WHERE contains(tags, "#Settlement") AND party5reputation
>> SORT file.name ASC
>
>> [!metadata|faction] Faction
>> ```dataview
>> TABLE without id file.link AS "Faction", party5reputation AS "Reputation"
>> FROM "Campaign"
>> WHERE contains(tags, "#Faction") AND party5reputation
>> SORT file.name ASC
>
>> [!metadata|faction] Location
>> ```dataview
>> TABLE without id file.link AS "POI", party5reputation AS "Reputation"
>> FROM "Campaign"
>> WHERE contains(tags, "#POI") AND party5reputation
>> SORT file.name ASC
>
>> [!metadata|faction] Government
>> ```dataview
>> TABLE without id file.link AS "Government", party5reputation AS "Reputation"
>> FROM "Campaign"
>> WHERE contains(tags, "#Government") AND party5reputation
>> SORT file.name ASC