...
tags:
  - "#Location"
  - "#Settlement"
art: z_Assets/Settlements/Meshwich.png
banner: on
settlementtype: Destroyed
defence: None
location:
  - "[[Odinys]]"
dominion:
...
>  |
> ---|---|
> **[[Kamderah]]** | `VIEW[round(23 / (({Travel Calculator#MilesPerHour}*{Travel Calculator#HoursPerDay})*{Travel Calculator#SpeedMultiplier}),1)]` Day(s)
