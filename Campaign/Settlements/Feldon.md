...
tags:
  - "#Location"
  - "#Settlement"
art: z_Assets/Settlements/Feldon.png
banner: on
pronounced: FELL-don
...
>  |
> ---|---|
> **[[Valdian]]** | `VIEW[round(66 / (({Travel Calculator#MilesPerHour}*{Travel Calculator#HoursPerDay})*{Travel Calculator#SpeedMultiplier}),1)]` Day(s)
...
Due to the threat of the Goblins within Feldon Forest, [[Kord Constructions]] have shifting from constructing buildings to building a palisade wall to help protect the citizens.
...
[[Feldon Planning.canvas|Feldon Planning]]